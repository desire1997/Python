...
How many sales have amounts greater than 1000?

How many sales belong to the "Tops" category with a quantity of 3?

What is the total sales amount for each category?

What is the average sales amount, grouped by category and status?

What are the total sales amounts, grouped by fulfilment type and shipment type?
...
sales_data = pd.read_excel('C:/Users/Lenovo/Documents/python project/FW/saless_data.xlsx')
